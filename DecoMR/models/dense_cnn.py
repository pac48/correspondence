...
import os
from DecoMR.utils.objfile import read_obj
...
class UVNet(nn.Module):
    def __init__(self, uv_channels=64, uv_res=128, warp_lv=2, uv_type='SMPL', norm_type='BN'):
        ...
        if uv_type == 'SMPL':
            ref_file = 'D:/correspondence/DecoMR/data/SMPL_ref_map_{0}.npy'.format(self.warp_res)
        elif uv_type == 'BF':
            ref_file = 'D:/correspondence/DecoMR/data/BF_ref_map_{0}.npy'.format(self.warp_res)
